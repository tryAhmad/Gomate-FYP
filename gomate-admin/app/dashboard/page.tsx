  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        if (!statsRes.ok || !trendRes.ok || !statusRes.ok) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{stats?.userGrowth || '0%'} from last month</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats?.activeDrivers.toLocaleString() || 0}</div>
            <p className="text-xs text-muted-foreground">{stats?.driverGrowth || '0%'} from last month</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats?.totalRides.toLocaleString() || 0}</div>
            <p className="text-xs text-muted-foreground">{stats?.rideGrowth || '0%'} from last month</p>
          </CardContent>
        </Card>
