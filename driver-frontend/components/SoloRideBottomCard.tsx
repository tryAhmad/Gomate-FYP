    ...
    <View style={styles.container}>
      ...
      <View style={styles.passengerRow}>
        {profilePhoto ? (
          ...
          <View style={styles.avatarPlaceholder}>
            <Text style={styles.avatarInitial}>{getInitial(passengerName)}</Text>
          </View>
        )}
        <View style={styles.passengerInfo}>
          <Text style={styles.passengerName}>{passengerName || 'Passenger'}</Text>
        </View>
      ...
      {rideStarted ? (
        ...
        <View style={styles.actionButtons}>
          ...
          {hasArrived ? (
            <TouchableOpacity style={styles.primaryButton} onPress={onStartRide}>
