...
export const SharedRideBottomCard: React.FC<SharedRideBottomCardProps> = ({
  ...
  const shouldShowEndRideButton = () => {
    return isLastStop && currentStop.type === 'destination' && currentStop.completed;
  };
      ...
      <View style={styles.currentStopSection}>
        <View style={styles.currentStopHeader}>
          <View style={styles.stopNumberBadge}>
            <Text style={styles.stopNumberText}>{currentStop.stopNumber}</Text>
          </View>
          <View style={styles.currentStopInfo}>
            <Text style={styles.currentStopType}>
              {currentStop.type === 'pickup' ? 'Pickup' : 'Destination'} • {currentStop.passengerName}
            </Text>
          ...
          {shouldShowContactButtons() && (
            <View style={styles.contactButtons}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => onWhatsApp(currentStop.passengerPhone, currentStop.passengerName)}
              >
