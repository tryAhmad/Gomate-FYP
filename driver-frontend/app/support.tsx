      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.optionDetails}>
            ...
            <Text style={styles.optionDetailText}>Available 9am – 9pm</Text>
          </View>
        </View>
        ...
        <View style={[styles.card, styles.emergencyCard]}>
          ...
          >
            <Ionicons name="shield" size={26} color="white" />
            <Text style={styles.optionButtonText}>Call Police</Text>
          </TouchableOpacity>
          <View style={styles.optionDetails}>
        ...
        <View style={[styles.card, styles.emergencyCard]}>
          <TouchableOpacity
            ...
            style={[styles.optionButton, styles.emergencyButton]}
          >
            <Ionicons name="medkit" size={26} color="white" />
            <Text style={styles.optionButtonText}>Call Ambulance</Text>
          </TouchableOpacity>
          <View style={styles.optionDetails}>
            <Ionicons name="call" size={18} color="#dc2626" />
            <Text style={styles.emergencyDetailText}>
